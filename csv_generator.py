...
# column name 
keys = countryListAllIsoData[0].keys()


with open('country.csv', 'w', newline='') as output_file: # open people csv file with 'w' mode 
    dict_writer = csv.DictWriter(output_file, keys)
    dict_writer.writeheader()
    dict_writer.writerows(countryListAllIsoData)
